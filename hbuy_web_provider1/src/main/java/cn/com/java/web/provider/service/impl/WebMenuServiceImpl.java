...
import cn.com.java.model.WebMenuEntity;
...
@Service
@Transactional
public class WebMenuServiceImpl extends BaseServiceImpl<WebMenuEntity> implements BaseService<WebMenuEntity> {
    ...
    public List<WebMenuEntity> findAll() throws Exception {
        System.out.println("走的为provider1...");
        //1.声明前台导航菜单集合

...
import cn.com.java.web.products.mapper.BaseMapper;
import cn.com.java.web.products.mapper.WebProductImgMapper;
...
public class BaseServiceImpl<T> implements BaseService<T>{
	...
	//商品详情图的mapper代理对象
	@Autowired
	protected WebProductImgMapper webProductImgMapper;
